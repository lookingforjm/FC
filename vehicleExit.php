...
$vehicleExit = "SELECT * FROM vehicle_records WHERE date_exit != 'NULL' OR date_exit != ''";
$queryVehicleExit = mysqli_query($link, $vehicleExit);
    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul class="toggleShow-items">
                ...
                <li>
                    <a href="./vehicleExit.php" class="active">
        ...
        <div class="section">
            ...
            <div class="content-body">
                <table class="table table-condensed table-striped table-hover table-bordered mt-5">
                    <thead class="bg-darkBlue text-center">
                        <tr>
                            <th width="20%">Username</th>
                            <th width="20%">Plate Number</th>
                            <th width="20%">Entry Date</th>
                            <th width="20%">Exit Date</th>
                            <th width="20%">Category</th>
                        </tr>
                    </thead>
                    <tbody class="text-center">
                        <?php
                            while ($row = mysqli_fetch_assoc($queryVehicleExit)) {
                                echo "
                                <tr>
                                    <td class='entry_td'>$row[username]</td>
                                    <td>$row[plate_num]</td>
