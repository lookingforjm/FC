                ...
                <div class="col-lg-4 col-md-4 col-sm-12  mx-auto">
                    <div class="card text-center">
                        <div class="card-header bg-darkBlue">
                            Update Total Spaces for "Class C" vehicles
                        </div>
                        <div class="card-body">
                            <form action="../query/spaceQuery.php?method=classC" method="POST">
                                <div class="row">
                                    <div class="col-12 my-2">
                                        <input type="text" name="totalClassC" class="form-control space-value" value="<?php echo $classCValue ?>">
                                    </div>
                                    <div class="col-12">
