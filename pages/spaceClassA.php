                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12  mx-auto">
                            <div class="card text-center">
                                <div class="card-header bg-darkBlue">
                                    Update Total Spaces for "Class A" vehicles
                                </div>
                                <div class="card-body">
                                    <form action="../query/spaceQuery.php?method=classA" method="POST">
                                        <div class="row">
                                            <div class="col-12 my-2">
                                                <input type="text" name="totalClassA" class="form-control space-value" value="<?php echo $classAValue ?>">
                                            </div>
                                            <div class="col-12">
